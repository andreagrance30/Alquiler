...
public class BeanAperturaCierreCaja implements Serializable { 
    ...
    public void Inicializa(){
        ...
        if(aperturacierrecaja == null){   
            ...
            aperturacierrecaja.setMontoInicial(new BigDecimal("100000"));
            ...
            aperturacierrecaja.setMontoEfectivoCierre(new BigDecimal("0"));
            aperturacierrecaja.setMontoChequeCierre(new BigDecimal("0"));
            aperturacierrecaja.setMontoTarjetaCierre(new BigDecimal("0"));
