...
public class ArqueosCajasDet implements Serializable {
    ...
    public ArqueosCajasDet(ArqueosCajasDetPK arqueosCajasDetPK, BigDecimal montoFisico, BigDecimal montoTeorico) {
        this.arqueosCajasDetPK = arqueosCajasDetPK;
    ...
    public BigDecimal getMontoTeorico() {
        return montoTeorico;
    }

    public void setMontoTeorico(BigDecimal montoTeorico) {
        this.montoTeorico = montoTeorico;
    }
