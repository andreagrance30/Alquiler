...
public class AjustesInventarios implements Serializable {
    ...
    private BigDecimal existenciaTeorica;
    @Size(max = 2147483647)
    @Column(name = "estado")
    ...
    public AjustesInventarios(Integer idAjusteInventario, String motivo, BigDecimal existenciaFisica, BigDecimal existenciaTeorica) {
        this.idAjusteInventario = idAjusteInventario;
        this.motivo = motivo;
    ...
    public BigDecimal getExistenciaTeorica() {
        return existenciaTeorica;
    }

    public void setExistenciaTeorica(BigDecimal existenciaTeorica) {
        this.existenciaTeorica = existenciaTeorica;
    }
