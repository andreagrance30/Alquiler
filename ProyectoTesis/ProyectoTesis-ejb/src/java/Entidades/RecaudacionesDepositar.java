...
public class RecaudacionesDepositar implements Serializable {
    ...
    private BigInteger totalCheque;
    @Column(name = "total_efectivo")
    private BigInteger totalEfectivo;
    ...
    public BigInteger getTotalCheque() {
        return totalCheque;
    }

    public void setTotalCheque(BigInteger totalCheque) {
        this.totalCheque = totalCheque;
    }

    public BigInteger getTotalEfectivo() {
        return totalEfectivo;
    }

    public void setTotalEfectivo(BigInteger totalEfectivo) {
