...
@NamedQueries({
    ...
    @NamedQuery(name = "PresupuestosClientesDet.findByIdDeposito", query = "SELECT p FROM PresupuestosClientesDet p WHERE p.presupuestosClientesDetPK.idDeposito = :idDeposito")})
public class PresupuestosClientesDet implements Serializable {
    ...
    public PresupuestosClientesDet(int idPresupuestoCliente, int idProducto, int idDeposito) {
        this.presupuestosClientesDetPK = new PresupuestosClientesDetPK(idPresupuestoCliente, idProducto, idDeposito);
    }
